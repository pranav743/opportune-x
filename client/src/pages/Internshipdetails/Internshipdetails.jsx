...
const Internshipdetails = () => {
  ...
  return (
       <div  className='mx-auto sm:w-[80%] w-[100%]' style={{height: 'auto', padding: '15px', backgroundColor: colors.secondary, boxShadow: `2.5px 5px 7.5px ${colors.hover}` , marginTop: '15px', borderRadius: '8px', display: 'flex', flexDirection: 'column', alignItems: 'center',flexWrap:'wrap'}}>
         <div className=''>
